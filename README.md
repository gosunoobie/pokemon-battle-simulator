...
Vue 3 + PixiJS 8 + GSAP 3, with **251 independently authored moves**, an optional effects package, previews from either side, and an independent animation playground.
...
See [Opponent previews](docs/OPPONENT_PREVIEW.md) for using all 251 moves from either side, adding artwork, supplying legal move IDs and the per-move verification coverage.
