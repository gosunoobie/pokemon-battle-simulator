...
test('all 335 move results survive without renderer, window, FX playback or async work', () => {
  ...
  MOVE_RULES.forEach((move,i)=>{
    ...
    assert.equal(result.after.actors.target.accuracyStage,['smokescreen','flash','sand-attack','mud-slap','kinesis'].includes(move.id)?-1:0)
