...
const experiences = [
  {
    id: 'simulation', number: '01', href: '/simulation.html', label: 'PLAY A BATTLE',
  ...
  {
    id: 'preview', number: '02', href: '/preview.html', label: 'TAKE A CLOSER LOOK',
  ...
  {
    id: 'playground', number: '03', href: '/playground.html', label: 'EXPLORE THE EFFECTS',
  ...
  <div class="home-shell">
    ...
    <main>
      ...
      <section id="experiences" class="home-experiences" aria-labelledby="experiences-title" tabindex="-1">
        <div class="home-section-heading"><h2 id="experiences-title">Three ways to explore</h2><span>Pick your starting point</span></div>
          ...
          <a v-for="experience in experiences" :key="experience.id" :href="experience.href" class="home-card" :class="`home-card-${experience.id}`">
            <div class="home-card-top">
              <span class="home-card-icon" aria-hidden="true">
                <svg v-if="experience.id === 'simulation'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="m4 4 5 1 10 13-3 3L5 9 4 4Z M17 3l3 1-1 4-3 3 M4 20l5-5 M3 17l4 4 M14 18l5-5"/></svg>
