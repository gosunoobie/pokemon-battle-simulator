...
Optional Vue-free battle effects for PixiJS 8 and GSAP 3. Contains 251 moves with independent recipes and package-relative effect assets. It imports neither battle-core nor host Pokémon artwork.
