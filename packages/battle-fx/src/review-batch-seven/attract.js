...
export const timing = Object.freeze({ contact: .92, duration: 6.01, markers: Object.freeze([
  { id: 'heart-orbit-fade', label: 'Final circling heart fade', timeSeconds: 5.59 },
]) })
...
export default function attract(context) {
  ...
  onFrame(update)
  tl.to(orbit,{alpha:1,duration:.28},.84).to(orbit,{alpha:0,duration:.42},5.59).call(()=>{update(.92);onCue({type:'impact'})},[],.92)
