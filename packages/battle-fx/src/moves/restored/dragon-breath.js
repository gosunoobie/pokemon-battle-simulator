...
// User-requested Flamethrower choreography, retained locally with a violet Dragon palette.
export default function dragonBreath(context) {
  ...
  const mouthGlow=new Sprite(glowTexture);mouthGlow.anchor.set(.5);mouthGlow.position.copyFrom(emission);mouthGlow.tint=0xa252f0;mouthGlow.blendMode='add';mouthGlow.width=mouthGlow.height=150;mouthGlow.alpha=0;temporary.addChild(mouthGlow)
  ...
  function spawnParticle() {
    ...
    p.tint = hot ? 0xead1ff : random() < 0.5 ? 0xbd7aff : 0x7d3de0
    p.blendMode = 'add'
...
function dragonBreath(timeline, move, hp) {
    timeline
