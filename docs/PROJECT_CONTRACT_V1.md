...
**Headless implementation:** [The first engine package](/Users/cdr/pokemon-battle-vue/packages/battle-engine/README.md) implements the proposed six-member, level-100 Open Singles configuration as the explicit `gen3opensinglesv1` profile. This supplies simulation and recovery APIs; the room service, live UI, 90-second deadline and deployment acceptance targets remain outstanding. This implementation note does not mark those operational proposals as tested capabilities.
