...
export default defineConfig({ plugins: [vue(), cleanPageUrlsPlugin(), simulationPlugin(capacity.serviceOptions), multiplayerPlugin(capacity.multiplayerOptions)], build: {
